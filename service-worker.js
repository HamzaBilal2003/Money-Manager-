const CACHE='money-manager-premium-v2';
const ASSETS=['./','./index.html','./dashboard.html','./category.html','./history.html','./setup.html','./styles.css','./app.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
